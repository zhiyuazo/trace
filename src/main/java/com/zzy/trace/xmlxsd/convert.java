...
public class convert {
	...
	public static void java2xml() {
        com.zzy.trace.xmlxsd.data.java2xml tmp = new com.zzy.trace.xmlxsd.data.java2xml("abc", "男", "北京", "朝阳区");
	...
	public static void xml2java() {
        File file = new File("java2xml.xml");
        com.zzy.trace.xmlxsd.data.java2xml tmp = JAXB.unmarshal(file, com.zzy.trace.xmlxsd.data.java2xml.class);
