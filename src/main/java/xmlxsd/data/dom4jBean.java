...
public class dom4jBean {
    ...
    protected List<dom4jBean.Childs> childs;
     ...
     * {@link dom4jBean.Childs }
     * 
     * 
     */
    public List<dom4jBean.Childs> getChilds() {
        if (childs == null) {
            childs = new ArrayList<dom4jBean.Childs>();
        }
        return this.childs;
    }
